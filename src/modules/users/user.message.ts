export const USERS_MESSAGES = {
  ...
  RESEND_verify_status_SUCCESS: 'Resend verify email success',
  ...
  USER_AVATAR_MUST_BE_A_STRING: 'User avatar must be a string',
  USER_AVATAR_LENGTH_MUST_BE_LESS_THAN_200: 'User avatar length must be less than 200',
  ...
  CCCD_LENGTH_MUST_BE_12: 'CCCD length must be 12',
